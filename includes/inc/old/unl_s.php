...
<!-- TemplateBeginEditable name="head" --><!-- TemplateEndEditable --><!-- InstanceEndEditable --><!-- InstanceParam name="leftRandomPromo" type="boolean" value="false" --><!-- InstanceParam name="bodyid" type="text" value="secure" -->
</head>
<body id="secure" class="liquid">
<p class="skipnav"> <a class="skipnav" href="#maincontent">Skip Navigation</a> </p>

<?php virtual('/ucomm/templatedependents/templatesharedcode/includes/siteheader/siteheader_secure.shtml'); ?>
	...
	<div class="clear">
		...
		<div id="breadcrumbs"> <!-- InstanceBeginEditable name="breadcrumbs" -->
			...
			<ul>
				...
				<li><a href="is.unl.edu">Information Services</a></li>
				<li><a href="http://ischc.unl.edu/">Computer Help Center</a></li>
				<li>Check-in System</li>
			</ul>
			<?php virtual('/ucomm/templatedependents/templatesharedcode/includes/badges/secure.html'); ?>
